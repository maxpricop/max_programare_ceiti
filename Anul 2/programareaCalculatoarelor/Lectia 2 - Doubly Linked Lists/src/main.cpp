...
int main() {
	...
	while (true) {
		...
		std::cout << "2. Adauga un element in linked list la o pozitie specificata. \n";
		std::cout << "3. Adauga un element in linked list la sfarsit.\n";
		std::cout << "4. Sterge un element din linked list in baza valorii.\n";
		std::cout << "5. Sterge un element din linked list in baza pozitiei din lista.\n";
		std::cout << "6. Afiseaza linked list.\n";
		std::cout << "7. Iesi din program.\n";
		...
		switch (userChoice) {
			...
			case 2: {
				int newData;
				std::cout << "Introdu ce informatie (int) vrei sa fie salvata in lista: ";
				std::cin >> newData;

				unsigned position;
				std::cout << "La ce pozitie vrei sa adaugi aceasta informatie: ";
				std::cin >> position;
